...
# Author: Jiri Motyl, Ph.D. (jiri.motyl@vfn.cz), October 2024

## Calculations based on the Neurostatus adaptation of the scoring system (Kappos et al.): https://www.neurostatus.net/scoring/index.php (with 12 Ambulation subscores as in iMed program)
...
# EDSS calculation script with ambulation score up to 13
